...
<body style="margin:0;padding:0;background-color:#e8e4da;">
  ...
  <div style="display:none;font-size:1px;color:#e8e4da;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
    Reset your MPower Founders password &mdash; this link expires in {{ $expiryMinutes }} minutes.
  </div>
        ...
        <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background-color:#f3f1ec;border-radius:20px;overflow:hidden;">
          ...
          <tr>
            <td class="email-padding" style="padding:48px 48px 40px;">
              ...
              <p style="margin:0 0 28px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:15px;line-height:1.6;color:#5c5c60;">
                Hi {{ $user->name }}, we received a request to reset the password for your MPower Founders account
                (<strong style="color:#0d0d0f;">{{ $user->email }}</strong>). Click the button below to choose a new one.
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="border-radius:999px;background-color:#caa64f;">
                    <!--[if mso]>
                    <a href="{{ $resetUrl }}" target="_blank" style="height:44px;v-text-anchor:middle;width:220px;" arcsize="50%" strokecolor="#caa64f" fillcolor="#caa64f">
                    <center style="color:#0d0d0f;font-family:Courier New,monospace;font-size:13px;font-weight:700;">Reset password</center>
                    </a>
                    <![endif]-->
                    <!--[if !mso]><!-->
              ...
              <p style="margin:32px 0 0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;line-height:1.6;color:#8a8a8f;">
                This link expires in {{ $expiryMinutes }} minutes. If the button above doesn't work, copy and paste this URL into your browser:
              </p>
              <p style="margin:8px 0 0;font-family:'Courier New',Courier,monospace;font-size:12px;line-height:1.6;word-break:break-all;">
                <a href="{{ $resetUrl }}" target="_blank" style="color:#caa64f;text-decoration:underline;">{{ $resetUrl }}</a>
              </p>
